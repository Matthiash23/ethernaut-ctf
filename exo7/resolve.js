...
let ExoC = require('./build/contracts/ExoSeven.json');
...
let contractAddress = "0xA26E92f7c1A0faE3eF2658D54De062C47a3078d6";
...
async function callFunc(){
    ...
    console.log(exo)
    let x = await exo.execute({from: "0xf63C073Fb0A9aeb8C708dEe86A6Eb0ac0c7A9886"});
    console.log(x)
